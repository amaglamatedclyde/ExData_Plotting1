...
two_day_subset <- subset(household_power_consumption, household_power_consumption$Date == "2007-02-01" | household_power_consumption == "2007-02-02")#rm(household_power_consumption)
